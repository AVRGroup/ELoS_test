...
for(i = 0; i < l; i++){
    ...
    a.innerHTML = selElmnt.options[selElmnt.selectedIndex].innerHTML + imgarr[selElmnt.selectedIndex];
    x[i].appendChild(a);
    ...
    create a new DIV that will act as an option item: */ c = document.createElement("DIV");
        ...
        and the selected item: */ var y, i, k, s, h, sl, yl;
            ...
            for(i = 0; i < sl; i++)if (s.options[i].innerHTML + imgarr[i] == this.innerHTML) {
                s.selectedIndex = i;
