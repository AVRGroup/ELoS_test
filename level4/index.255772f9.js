...
phaseGeneration.push(()=>{
    document.getElementById("phaseTitle").innerText = "N\xedvel 4 - Fase 1 de 8";
...
// Phase 2
phaseGeneration.push(()=>{
    document.getElementById("phaseTitle").innerText = "N\xedvel 4 - Fase 2 de 8";
    document.getElementById("phaseObjective").innerText = "Abra a porta, fa\xe7a o rob\xf4 chegar ao cristal, ap\xf3s isso, o colete.";
    camera.position.set(0, 15, 30);
    actor.position.set(gridMapHelper.getGlobalXPositionFromCoord(0), 1.0, gridMapHelper.getGlobalZPositionFromCoord(5));
    actor.rotation.set(0, (0, _util.degreeToRadians)(90), 0);
...
// Phase 3
phaseGeneration.push(()=>{
    document.getElementById("phaseTitle").innerText = "N\xedvel 4 - Fase 3 de 8";
    document.getElementById("phaseObjective").innerText = "Abra a porta, fa\xe7a o rob\xf4 chegar ao cristal, ap\xf3s isso, o colete.";
...
//Phase 4
phaseGeneration.push(()=>{
    document.getElementById("phaseTitle").innerText = "N\xedvel 4 - Fase 4 de 8";
    document.getElementById("phaseObjective").innerText = "Abra a porta, fa\xe7a o rob\xf4 chegar ao cristal, ap\xf3s isso, o colete.";
    sceneProperties.executing = false;
    camera.position.set(0, 15, 30);
    actor.position.set(gridMapHelper.getGlobalXPositionFromCoord(0), 1.0, gridMapHelper.getGlobalZPositionFromCoord(5));
...
//Phase 5
phaseGeneration.push(()=>{
    document.getElementById("phaseTitle").innerText = "N\xedvel 4 - Fase 5 de 8";
    document.getElementById("phaseObjective").innerText = "Abra a porta, fa\xe7a o rob\xf4 chegar ao cristal, ap\xf3s isso, o colete.";
    sceneProperties.executing = false;
    camera.position.set(0, 15, 30);
    actor.position.set(gridMapHelper.getGlobalXPositionFromCoord(0), 1.0, gridMapHelper.getGlobalZPositionFromCoord(5));
    actor.rotation.set(0, (0, _util.degreeToRadians)(90), 0);
    objectives = (0, _util.loadDefaultObjectives)(5);
    ...
    doors.push(new (0, _cranckDoorDefault.default)(crancks[2]));
    doors.push(new (0, _cranckDoorDefault.default)(crancks[3]));
    doors.push(new (0, _cranckDoorDefault.default)(crancks[4]));
    crancks[0].position.set(gridMapHelper.getGlobalXPositionFromCoord(0), 1, gridMapHelper.getGlobalZPositionFromCoord(8));
    ...
    portaFechada = ()=>{
        ...
        else if ((0, _util.checkCollision)(actor.getObjectByName("interactionReference"), cranckInteractionReferences[4], gridMapHelper)) return !openDoors[4];
        else {
            consoleElement.innerText += "\xc9 preciso estar de frente de uma manivela para usar este comando.\n";
            return false;
        }
    ...
    girarManivela = ()=>{
        return new Promise((resolve)=>{
            ...
            } else if ((0, _util.checkCollision)(actor.getObjectByName("interactionReference"), cranckInteractionReferences[4], gridMapHelper)) {
                function translateDoor() {
                    doors[4].lerpDoor(0, -2);
                    doors[4].rotateCranckZ((0, _util.degreeToRadians)(-5));
                    resolve();
                }
...
//Phase 6
phaseGeneration.push(()=>{
    document.getElementById("phaseTitle").innerText = "N\xedvel 4 - Fase 6 de 8";
    document.getElementById("phaseObjective").innerText = "Abra a porta, fa\xe7a o rob\xf4 chegar ao cristal, ap\xf3s isso, o colete.";
    sceneProperties.executing = false;
    camera.position.set(0, 15, 30);
    actor.position.set(gridMapHelper.getGlobalXPositionFromCoord(0), 1.0, gridMapHelper.getGlobalZPositionFromCoord(5));
...
//Phase 7
phaseGeneration.push(()=>{
    document.getElementById("phaseTitle").innerText = "N\xedvel 4 - Fase 7 de 8";
    document.getElementById("phaseObjective").innerText = "Abra a porta, fa\xe7a o rob\xf4 chegar ao cristal, ap\xf3s isso, o colete.";
    sceneProperties.executing = false;
    camera.position.set(0, 15, 30);
    actor.position.set(gridMapHelper.getGlobalXPositionFromCoord(0), 1.0, gridMapHelper.getGlobalZPositionFromCoord(5));
    ...
    coletarCristal = ()=>{
        ...
        if ((0, _util.checkCollision)(actor.getObjectByName("interactionReference"), objectives[0], gridMapHelper)) {
            ...
            consoleElement.innerText += "Cristal coletado com sucesso.\n";
            gridMapHelper.obstacles[3].active = false;
        } else if ((0, _util.checkCollision)(actor.getObjectByName("interactionReference"), objectives[4], gridMapHelper)) {
            objectives[4].visible = false;
            consoleElement.innerText += "Cristal coletado com sucesso.\n";
            gridMapHelper.obstacles[4].active = false;
        } else consoleElement.innerText += "Rob\xf4 n\xe3o est\xe1 em frente ao cristal.\n";
...
//Phase 8
phaseGeneration.push(()=>{
    document.getElementById("phaseTitle").innerText = "N\xedvel 4 - Fase 8 de 8";
    document.getElementById("phaseObjective").innerText = "Abra a porta, fa\xe7a o rob\xf4 chegar ao cristal, ap\xf3s isso, o colete.";
    sceneProperties.executing = false;
    camera.position.set(0, 15, 30);
    actor.position.set(gridMapHelper.getGlobalXPositionFromCoord(0), 1.0, gridMapHelper.getGlobalZPositionFromCoord(5));
...
const stonePath = new URL(require("353cee51943916b4")).toString();
let cubeMaterials = [
...
},{"three":"3XrwE","./cranck":"JDM9K","353cee51943916b4":"4dqGk","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"JDM9K":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _three = require("three");
class CranckTorus extends _three.Mesh {
...
module.exports = require("1e4fc11351cf28ae").getBundleURL("l1J9r") + "../door2.3ff487ff.jpg" + "?" + Date.now();

},{"1e4fc11351cf28ae":"hPpBg"}],"ivPoA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _three = require("three");
class Fence extends _three.Mesh {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["4O5wh","c1rFl"], "c1rFl", "parcelRequiredf3e")
